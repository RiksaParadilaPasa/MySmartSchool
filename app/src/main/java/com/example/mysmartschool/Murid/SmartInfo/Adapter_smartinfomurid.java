...
public class Adapter_smartinfomurid extends RecyclerView.Adapter<Adapter_smartinfomurid.ViewHolder> {
    ...
    public Adapter_smartinfomurid(Context mContext, List<Entitiy_smartinfo> infoList){
