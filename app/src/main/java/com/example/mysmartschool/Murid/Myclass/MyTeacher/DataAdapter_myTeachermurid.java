...
public class DataAdapter_myTeachermurid extends RecyclerView.Adapter<DataAdapter_myTeachermurid.ViewHolder> {
    ...
    public DataAdapter_myTeachermurid(Context mContext, List<Entity_myteacher> myteacherList){
...
//
    ...
    @Override
    public DataAdapter_myTeachermurid.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DataAdapter_myTeachermurid.ViewHolder holder, final int position) {
...
//                    ini ngirim data untuk di ambil pada activity lain
                ...
                //                    ini pindah activity
                Intent inten = new Intent(mContext, MyTeachermurid.class);
