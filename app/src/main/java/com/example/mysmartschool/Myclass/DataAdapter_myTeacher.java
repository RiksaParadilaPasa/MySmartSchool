...
import com.example.mysmartschool.SmartInfo.Adapter_smartinfo;
import com.example.mysmartschool.SmartInfo.Entitiy_smartinfo;
import com.example.mysmartschool.SmartInfo.InfoActivity;
...
public class DataAdapter_myTeacher extends RecyclerView.Adapter<DataAdapter_myTeacher.ViewHolder> {
    ...
    private List<Entity_myteacher> infoList;
    private Context mContext;


    //    ini seperti constructor
    public DataAdapter_myTeacher(Context mContext, List<Entity_myteacher> infoList){
