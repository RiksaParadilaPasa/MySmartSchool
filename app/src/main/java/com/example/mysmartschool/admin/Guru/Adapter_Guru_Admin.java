...
public class Adapter_Guru_Admin extends RecyclerView.Adapter<Adapter_Guru_Admin.ViewHolder> {
    ...
    public Adapter_Guru_Admin(Context mContext, List<Entity_Guru_Admin> myteacherList){
...
//
    ...
    @Override
    public Adapter_Guru_Admin.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Adapter_Guru_Admin.ViewHolder vh = new Adapter_Guru_Admin.ViewHolder(v);
    ...
    @Override
    public void onBindViewHolder(Adapter_Guru_Admin.ViewHolder holder, final int position) {
//          ini untuk inisialisasi entity
        Entity_Guru_Admin myteacher = myteacherList.get(position);
