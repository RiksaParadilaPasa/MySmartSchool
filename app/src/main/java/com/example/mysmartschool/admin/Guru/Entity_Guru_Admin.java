...
public class Entity_Guru_Admin {
    ...
    public Entity_Guru_Admin(String idGuru, String nip_guru, String nama_guru, String nomorHp_guru, String password) {
        this.idGuru = idGuru;
