package com.example.mysmartschool.Guru.Myclass;
...
public class MyClassFragment extends Fragment {
    ...
    private DataAdapter_myTeacher adapterMyTeacher;
    ...
    public void onStart() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapterMyTeacher = new DataAdapter_myTeacher(getContext(),myteacherList);
