...
public class SmartVideoMuridFragment extends Fragment {
    ...
    private Adapter_smartvideomurid adapterSmartvideo;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_smart_video_murid,container,false);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot infoSnapShot : dataSnapshot.getChildren()){
                    Entity_smartvideomurid video = infoSnapShot.getValue(Entity_smartvideomurid.class);
                    smartvideoList.add(video);
                }

                adapterSmartvideo = new Adapter_smartvideomurid(getContext(),smartvideoList);
    ...
    public void showDialogAdd(){
        ...
        tambahInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Entity_smartvideomurid Info = new Entity_smartvideomurid(idVideo , penjudul, pemapel);
