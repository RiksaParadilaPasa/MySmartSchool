...
public class Adapter_Admin_Admin extends RecyclerView.Adapter<Adapter_Admin_Admin.ViewHolder> {
    ...
    public Adapter_Admin_Admin(Context mContext, List<Entity_Admin_Admin> myteacherList){
...
//          ini untuk inisialisasi entity
        Entity_Admin_Admin myteacher = myteacherList.get(position);

//             ini untuk mengambil data dari ENtity dan nanti akan diambil dan di set/tampilkan oleh MainACtivity(RecyclerActivity)
        holder.nameGuru.setText(String.valueOf(myteacher.getNama_admin()));
...
//                    ini ngirim data untuk di ambil pada activity lain
                bundle.putString("id",myteacherList.get(position).getIdAdmin());
                bundle.putString("nama",myteacherList.get(position).getNama_admin());
                //                    ini pindah activity
