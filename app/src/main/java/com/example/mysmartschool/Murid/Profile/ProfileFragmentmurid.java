package com.example.mysmartschool.Murid.Profile;
...
public class ProfileFragmentmurid extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_profile_murid, container, false);
    }
        ...
        call.enqueue(new Callback<SiswaProfileRespone>() {
            ...
            public void onResponse(Call<SiswaProfileRespone> call, Response<SiswaProfileRespone> response) {
                if (response.body() == null) {
                    Toast.makeText(ProfileFragmentmurid.this.getActivity(), "Aplikasi sedang bermasalah", Toast.LENGTH_SHORT).show();
                    return;
                }
