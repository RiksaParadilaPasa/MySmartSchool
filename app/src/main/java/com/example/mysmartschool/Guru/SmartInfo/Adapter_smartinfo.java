...
public class Adapter_smartinfo extends RecyclerView.Adapter<Adapter_smartinfo.ViewHolder> {
    ...
    String kirims,juduls,tanggals,abouts,urls;
...
//    dan pada class Viewholder ini harus extends ke recyclerview
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View v){
            ...
            img = (ImageView)v.findViewById(R.id.iv_berita);
...
//                    ini untuk menjalankan inten
        ...
        holder.btnChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                urls = info.getUrl();
                showDialogWhatToDo(id,tanggals);
            }
        });
    ...
    private void showDialogWhatToDo(final String idInfo, final String Tanggal) {
        ...
        btnDoUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                showDialogUpdateInfo(idInfo,Tanggal);
                alertDialog.dismiss();
            }
        });
...
//
    ...
    private void showDialogUpdateInfo(final String idInfo,final String Tanggal) {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(mContext);
        LayoutInflater inflater = LayoutInflater.from(mContext);
